...
export default function SignIn() {
  ...
  const handleSubmit=async (e)=>{
    e.preventDefault(); // to stop refresshing page
  ...
  return (
    //it should be at least of size screen 
    <div className='min-h-screen mt-20'>
      <div className='flex p-3 max-w-3xl mx-auto flex-col md:flex-row'>
        ...
        <p className='text-sm mt-5'>
          Publish Your Blog's here . Today's Blog is one of the best platfrom to read blogs about development.
