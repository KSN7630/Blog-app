...
export default function DashComments() {
  ...
  return (
    <div className='w-screen table-auto overflow-x-scroll md:mx-auto p-3 scrollbar scrollbar-track-slate-100  scrollbar-thumb-slate-300 
    dark:scrollbar-track-slate-700 dark:scrollbar-thumb-slate-500'>
      {currentUser.isAdmin && comments.length >0  ? (
        <>
        <Table hoverable className='shandow-md'>
      ...
      <Modal show ={showModal} onClose={()=> setShowModal(false)} popup size='md'>
        ...
        <Modal.Body>
          <div className="text-center">
            ...
            <h3 className='mb-5 text-lg text-gray-500 dark:text-grey-400'>Are you sure you want to delete this user?</h3>
